...
import 'package:kiemtra/DetailProduct.dart';
        ...
        child: GridView.count(
          ...
          children: [
            ...productProvider.list.map((e) {
              return Padding(
                padding:
                const EdgeInsets.only(left: 4.0, right: 4, top: 0, bottom: 2),
                child: Container(
                  decoration:
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextButton(
                          ...
                          child: Text('BUY', style: TextStyle(fontSize: 14)), )
                    ],
                  ),
                ),
              );
